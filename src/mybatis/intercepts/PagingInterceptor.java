...
public class PagingInterceptor implements Interceptor {
	...
	public Object intercept(Invocation inv) throws Throwable {
		...
		if (target instanceof StatementHandler) {
			...
			Object parameterHandler = getFieldObjectByFieldName(delegate, "parameterHandler");
			
			Object parameterObject = getFieldObjectByFieldName(parameterHandler, "parameterObject");
			...
			if (parameterObject != null) {
				...
				if (parameterObject instanceof Pagination) {
					...
					if (parameterObject instanceof Map) {
						...
						for (Object item : map.values()) {
							if (item instanceof Pagination && item!=null) {
				...
				if (pagination != null) {
					...
					if (pagination.isTotol()) {
						Connection conn = (Connection)inv.getArgs()[0];
						String countSql = pagination.getCountSql(boundSql.getSql());
					...
					setFieldObjectByFieldName(boundSql, "sql", pagination.getPaginationSql(boundSql.getSql())); //将分页sql语句反射回BoundSql.   
